...
class CandidateTableAdmin(admin.ModelAdmin):
    readonly_fields=('fileUploadUser','candidateFileName','candidateFileName','candidateFileNamePDF','skill_keywords_full','candidateFileContents','date_added','fileUploadDate')
